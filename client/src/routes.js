...
const routes = [
  ...
  // ========================== Legacy CRM / Sales CRM ==========================
  {
    name: "Properties",
    separator: "Legacy CRM / Sales CRM",
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/properties",
    icon: <Icon as={LuBuilding2} width="20px" height="20px" color="inherit" />,
    component: Property,
  ...
  },
  {
    ...
    sidebarName: "Active/Inactive Modules",
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
